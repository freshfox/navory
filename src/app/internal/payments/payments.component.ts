	...
	template: `
		<div class="flex-items-center">
			<div class="flex space-x-6 p-6">
				<div *ngFor="let account of bankAccounts$ | async"
					...
					<div class="flex-shrink-0">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
							 class="h-6 w-6 text-gray-600" *ngIf="account.manual">
				...
				<div (click)="addBankAccount()"
					 class="relative cursor-pointer rounded-lg border border-gray-300 bg-white px-5 py-3 shadow-sm flex flex-col items-center justify-center hover:border-gray-400 hover:bg-gray-100">
					...
					<p class="mb-0 mt-1">Hinzufügen</p>
				</div>
			</div>
		</div>
