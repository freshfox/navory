import {
    Component, NgModule, ViewChild, OnInit, ViewContainerRef, Compiler, ReflectiveInjector, Injectable, Injector,
    ComponentRef, trigger, transition, style, animate, AfterViewInit, state
} from "@angular/core";
